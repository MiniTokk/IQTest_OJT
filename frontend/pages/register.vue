  ...
  <div class="wrapper fadeInDown" v-if="!$auth.loggedIn">
    <div class id="formContent">
     <!--Tab Titles-->
        ...
        <h2 class="inactive underlineHover"><NuxtLink to='/login' v-if="!$auth.loggedIn">Log In</NuxtLink> </h2>
      <!--Register Form-->
        <form ref="registerform" @submit.prevent="register">
          <input  class="fadeIn second px-20"
          name="name"
          type="name"
          required
          autofocus
      ...
      <br>
        ...
        placeholder="Email"
         ...
         <br>
         <br>
    <input class="fadeIn fourth" type="password" placeholder="Password" name="password" required autocomplete="current-password">
